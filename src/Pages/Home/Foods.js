...
const Foods = () => {
  ...
  useEffect(() => {
    fetch("https://server-food-delivery.vercel.app/products")
      .then((res) => res.json())
      ...
      <section className="_ftre_fd_dlvry2_sec">
        <div className="container">
          <div className="_ftre_fd_dlvry2_top">
            <h1 className="_ftre_fd_dlvry2_tit4">Popular Menu</h1>
            ...
            <Link to="/all-products" className="_ftre_fd_dlvry2_btn">
              <button className="_ftre_fd_dlvry2_btn">
                ...
                >
                  <path
                    fill="#36BA58"
                    d="M0 12.35L5.565 7 0 1.65 1.717 0 9 7l-7.283 7L0 12.35z"
                  />
                </svg>
              </button>
            </Link>
